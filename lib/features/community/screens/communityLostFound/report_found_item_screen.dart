...
class _ReportFoundItemScreenState extends State<ReportFoundItemScreen> {
  ...
  Future<void> _submitReport() async {
    ...
    try {
      await lostFoundProvider.reportFoundItem(
      ...
      if (mounted) {
        SnackbarService.success('Found item reported successfully');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(title: "Report Found Item", centerTitle: true),
      body: Form(
        key: _formKey,
        child: ListView(
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'e.g., Brown Leather Wallet',
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'Describe the item found...',
                border: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(12),
                ),
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'e.g., Student Union, Cafeteria',
                border: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(12),
                ),
